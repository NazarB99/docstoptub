...
import {getPatients, markAsDone} from '../actions/userActions'
import {
  userIsCalling,
...
class MainScreen extends Component {
  ...
  componentWillReceiveProps(props) {
    ...
    //   this.props.getPatients(props.current_user.user.token)
    // }
  }
